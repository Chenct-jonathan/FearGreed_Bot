...
def getResult(inputSTR, utterance, args, resultDICT):
    ...
    if utterance == "[下禮拜一][看來][也是]大風大浪":
        resultDICT["Fear"].append("恐懼")
        pass

    if utterance == "[不是]要跌超過[20%][以上][才][算]空頭[嗎]":
        resultDICT["Fear"].append("恐懼")
        pass
    ...
    if utterance == "[中][國][經濟]增長[一直][在]放緩":
        resultDICT["Fear"].append("恐懼")
        pass
    ...
    if utterance == "[人們]擔心最[大][消費國][中][國][的][需]求":
        resultDICT["Fear"].append("恐懼")
        pass
    ...
    if utterance == "[以][美元]計價[的][金屬]對[其][他][貨幣]持[有][者]來說更加昂貴":
        resultDICT["Fear"].append("恐懼")
        pass
    ...
    if utterance == "[所以][請]謹慎[操作][在][接下來][的][幾天]":
        resultDICT["Fear"].append("恐懼")
        pass
    ...
    if utterance == "[這][次][外資]因[為]太看好[中][國]":
        resultDICT["Fear"].append("恐懼")
        pass
    ...
    if utterance == "無[量][的]上漲經[不][起][一][點][點][的]跌勢":
        resultDICT["Fear"].append("恐懼")
        pass
