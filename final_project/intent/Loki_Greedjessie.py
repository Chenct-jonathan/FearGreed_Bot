...
def getResult(inputSTR, utterance, args, resultDICT):
    ...
    if utterance == "[今天][台指期]未平倉空單[已經][降到][2個多月][以來][的][新低]":
        resultDICT["Greed"].append("貪婪")
        pass

    if utterance == "[今天][大盤][出量][上攻][遇壓][沒][站上][不過]收[了]一根腳":
        resultDICT["Greed"].append("貪婪")
        pass
    ...
    if utterance == "[外資]未平倉口數[久違][將]未平倉[水位][空單][低於][20000][口]":
        resultDICT["Greed"].append("貪婪")
        pass
    ...
    if utterance == "[夜盤][帥啦][衝啦][帶領][亞谷][紫蝶][反彈][帶領][歐][美股][市]回穩向上":
        resultDICT["Greed"].append("貪婪")
        pass
    ...
    if utterance == "並[可]望[在][未來]幾[年內]達到[一定][規模][的][市占率]":
        resultDICT["Greed"].append("貪婪")
        pass
